...
public class PermasalahanDaoImpl implements PermasalahanDao{
    ...
    private static final String SQL_GETPERMASALAHAN_BYIDKASUS ="SELECT p.*,dk.bobot FROM permasalahan p, detail_kasus dk "
            + "WHERE dk.id_kasus=? and dk.id_permasalahan = p.id";
...
//    
    ...
    public static final class PermasalahanParameterizeRowMapper implements 
        ...
        public Permasalahan mapRow(ResultSet rs, int i) throws SQLException {
            ...
            permasalahan.setIsiPermasalahan(rs.getString("isi_permasalahan"));
    ...
    public List<Permasalahan> getAllPermasalahanByIdKasus(Integer idKasus) {
        List<Permasalahan> permasalahans = jdbcTemplate.query(SQL_GETPERMASALAHAN_BYIDKASUS, new PermasalahanBobotParameterizeRowMapper(),idKasus);
        return permasalahans;
    }
